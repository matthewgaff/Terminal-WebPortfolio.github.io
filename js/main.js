...
function enterKey(e) {
  ...
  if (pw) {
    ...
    if (e.keyCode == 13) {
      ...
      git = commands.length;
      addLine("visitor@MAG.com:~$ " + command.innerHTML, "no-animation", 0);
...
function commander(cmd) {
  switch (cmd.toLowerCase()) {
    ...
    case "video":
      ...
      break;
    case "sudo":
      addLine("NOOOOOOO!!!!!", "color2", 80);
      setTimeout(function() {
        window.open('https://i.imgflip.com/4qrymq.jpg');
      }, 1000); 
      break;
    case "social":
    ...
    case "history":
      ...
      break;
    case "email":
      addLine('Opening mailto:<a href="mailto:matthewgaffoor9@gmail">matthewgaffoor9@gmail.com</a>...', "color2", 80);
      newTab(email);
      break;
    case "clear":
      setTimeout(function() {
